...
public class TreeImpl <E extends Comparable<? super E>> implements Tree<E> {
    ...
    public class NodeAndParent{
        ...
        public NodeAndParent(Node<E> current, Node<E> parent, int nodeLevel) {
    ...
    private NodeAndParent doFind (E value){
        ...
        while (current!=null){
            ...
            if (current.getValue().equals(value)){
                return new NodeAndParent(current, parent, nodeLevel);
            }
            parent = current;
        ...
        return new NodeAndParent(null,parent,nodeLevel);
    }
    ...
    public boolean add(E value) {
        ...
        node.setLevel(nodeAndParent.nodeLevel);
        if (nodeAndParent.nodeLevel>level){
            level = nodeAndParent.nodeLevel;
        }
        if(isEmpty()){
            root = node;
